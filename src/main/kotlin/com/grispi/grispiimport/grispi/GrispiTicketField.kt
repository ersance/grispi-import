...
class GrispiTicketField(
    ...
    class Builder {
        ...
        fun build(): GrispiTicketField {
            return GrispiTicketField(key, name, type, descriptionForAgents, descriptionForEndUsers, titleForAgents, titleForEndUsers, required, permission, attributes, options)
        }
    }
